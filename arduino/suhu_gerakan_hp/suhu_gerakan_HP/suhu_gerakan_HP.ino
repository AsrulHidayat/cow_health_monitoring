...
const char* password = "mudahbisa";

// ========================================================
// 🔹 URL Server API
// ========================================================
const char* serverTempUrl = "http://10.125.65.77:5001/api/temperature";  // Endpoint suhu
const char* serverActUrl  = "http://10.125.65.77:5001/api/activity";     // Endpoint aktivitas
