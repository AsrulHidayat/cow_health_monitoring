...
const HeaderSection = ({
  ...
  // Jika tidak ada data sapi, tidak menampilkan apa pun
  if (!cows || cows.length === 0) return null;

  return (
    // Header utama dengan layout flex dan tampilan bersih
    <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100">

      {/* Bagian kiri header (dropdown & status sapi) */}
      <div className="flex items-center gap-4">

        {/* Dropdown untuk memilih sapi berdasarkan ID/tag */}
        <Dropdown
          value={cowId}
        ...
        {/* Menampilkan kategori rata-rata jika ada */}
        {avgCategory && (
        ...
        {/* Menampilkan status pemeriksaan sapi */}
        <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg border border-gray-200">
        ...
        {/* Menampilkan kondisi sapi (misal: sehat/sakit/lemah) */}
        <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg border border-gray-200">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="text-sm font-medium">Hapus ID Sapi</span>
        </button>
        ...
        >
          ...
          <span className="text-sm font-medium">Restore Sapi</span>
        </button>
      </div>
    </div>
  );
