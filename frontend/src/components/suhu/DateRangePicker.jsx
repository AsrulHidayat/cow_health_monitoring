...
export default function DateRangePicker({ onApply, onReset, stats }) {
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 animate-fadeIn">
            <div className="p-4 border-b border-gray-100">
              <h3 className="text-lg font-semibold text-gray-800">Filter Berdasarkan Tanggal</h3>
              <p className="text-xs text-gray-500 mt-1">Pilih rentang waktu untuk melihat data</p>
            </div>
              ...
              {stats && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  ...
                  <div className="text-xs text-blue-700 space-y-1">
                    <p>Total Record: <span className="font-bold">{stats.count || 0}</span></p>
                    {stats.firstRecord && (
                      <p>Data Pertama: <span className="font-medium">
                        {new Date(stats.firstRecord).toLocaleDateString('id-ID')}
                      </span></p>
                    )}
                    {stats.lastRecord && (
                      <p>Data Terakhir: <span className="font-medium">
