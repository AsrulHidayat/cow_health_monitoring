...
// PENYESUAIAN
// Objek ini menyimpan string class Tailwind SECARA LENGKAP.
// Tailwind dapat memindai (scan) string lengkap ini saat build.
const colorStyles = {
  pink: {
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-8">
                  ...
                  {[
                    ...
                    <div
                      key={i}
                      // 👇 PERBAIKAN 1: Menggunakan string lengkap dari 'colorStyles'
                      className={`rounded-xl p-5 border hover:shadow-md transition-shadow ${
                        colorStyles[f.color].card
                      }`}
                    >
                      <div
                        // 👇 PERBAIKAN 2: Menggunakan string lengkap dari 'colorStyles'
                        className={`w-10 h-10 rounded-lg flex items-center justify-center mx-auto mb-4 ${
                          colorStyles[f.color].icon
                        }`}
                      >
                        <svg
            ...
            <div className="relative">
              ...
              <div className="space-y-8 relative">
                {[
                  ...
                  >
                    <div
                      className={`w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0 z-10 shadow-lg transition-transform group-hover:scale-110 ${
